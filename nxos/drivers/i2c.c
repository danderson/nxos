...
void i2c_register(U8 sensor, U8 address, bool lego_compat) {
 ...
 */
i2c_txn_err i2c_start_transaction(U8 sensor, i2c_txn_mode mode,
 ...
 */
void i2c_set_bus_state(U8 sensor, U8 next_state) {
  volatile struct i2c_port *p;
